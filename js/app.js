...
//FLIPPING CARDS
//EVENT LISTENER TO DECK INSTEAD OF CARDS
...
//RESET/NEW GAME
//FUNCTION TO RESET BOARD THAT INCLUDES ALL THE RESET FUNCTIONS AND
//LOOP TO ENSURE ALL CARDS HAVE ONLY A CLASS OF card
function resetBoard() {
...
let matchedPair = "Match!";
let misMatch = "Not a match!";
let finished = "You've matched them all!";
...
//CHANGING STAR RATING BASED ON COUNTER`
function starCounter() {
  if (myCounter === 12 || myCounter === 16 || myCounter === 20) {
    hideStar();
    }
};

//LOOP FOR HIDING STARS; IF DISPLAY IS NOT NONE THEN CHANGE TO NONE AND BREAK
function hideStar() {
  for(star of stars) {
...
//LOOP THROUGH STAR STYLES TO CLEAR OUT DISPLAYS TO SHOW ALL STARS AGAIN
function resetStar() {
...
// ATTEMPTED TO REMOVE STAR AND CHANGE STAR COLORING; ISSUE I'M HAVING IS BRINING THE STARS BACK
// function removeStar() {
//   starList.lastElementChild.remove();
...
//WRITE TO MODAL
function writeModal() {
  finalTimer.innerHTML = String(timer.innerHTML)+'.';
  finalMoves.innerHTML = myCounter;
